...
class Settings(BaseSettings):
    PROJECT_NAME: str = "Axios Authentication & Authorization Service"
    VERSION: str = "1.0.0"
    ...
    EMAILS_FROM_NAME: str = os.getenv("EMAILS_FROM_NAME", "Axios Security")
    EMAILS_FROM_ADDRESS: str = os.getenv("EMAILS_FROM_ADDRESS", "no-reply@axios.ai")

    # Bootstrap Super Admin Credentials
    SUPERADMIN_EMAIL: str = os.getenv("SUPERADMIN_EMAIL", "admin@axios.ai")
