...
function useOrganicGraphData(packages: KnowledgePackageItem[]) {
  ...
  useEffect(() => {
    const nodes: GraphNode[] = [
      {
        id: "center_hub",
        label: "Axios Reasoning Core",
        type: "HUB",
        category: "Central Core",
        urn: "urn:axios:core:reasoning",
        x: 400,
        y: 240,
        isCenter: true,
      ...
      },
      {
        ...
        type: "HUB",
        category: "Package",
        urn: "urn:axios:pkg:cooling-water-101",
        x: 190,
        y: 160,
        isFocal: true,
      ...
      },
      {
        ...
        type: "HUB",
        category: "Package",
        urn: "urn:axios:pkg:sys-arch-2026",
        x: 610,
        y: 150,
        isFocal: true,
        connections: ["center_hub"],
      ...
      },
      {
        ...
        type: "HUB",
        category: "Compliance",
        urn: "urn:axios:doc:osha-1910",
        x: 530,
        y: 360,
        isFocal: true,
        connections: ["center_hub"],
      },
      { id: "sat_1", label: "PT-101 Gauge", type: "EQUIPMENT", category: "Sensor", urn: "urn:axios:asset:pt101", x: 165, y: 125, connections: ["focal_top_left"] },
      { id: "sat_2", label: "Valve VLV-302", type: "SENSOR", category: "Valve", urn: "urn:axios:asset:vlv302", x: 155, y: 210, connections: ["focal_top_left"] },
      { id: "sat_3", label: "Iso Specs", type: "DOCUMENT", category: "Spec", urn: "urn:axios:doc:iso", x: 150, y: 235, connections: ["focal_top_left"] },
      { id: "sat_4", label: "Ref Check", type: "DOCUMENT", category: "Doc", urn: "urn:axios:doc:ref", x: 210, y: 270, connections: ["focal_top_left"] },

      { id: "sat_5", label: "Top Bound", type: "DOCUMENT", category: "Doc", urn: "urn:axios:doc:tb", x: 560, y: 130, connections: ["focal_top_right"] },
      { id: "sat_6", label: "Edge Node", type: "EQUIPMENT", category: "Asset", urn: "urn:axios:asset:en", x: 640, y: 90, connections: ["focal_top_right"] },
      { id: "sat_7", label: "Rule Tier", type: "DOCUMENT", category: "Rule", urn: "urn:axios:rule:tier", x: 615, y: 245, connections: ["focal_top_right"] },
      { id: "sat_8", label: "Standard", type: "DOCUMENT", category: "Spec", urn: "urn:axios:doc:std", x: 615, y: 275, connections: ["focal_top_right"] },

      { id: "sat_9", label: "Flow Sensor", type: "SENSOR", category: "Sensor", urn: "urn:axios:asset:fs", x: 340, y: 300, connections: ["center_hub"] },
      { id: "sat_10", label: "Mid Spec", type: "DOCUMENT", category: "Spec", urn: "urn:axios:doc:ms", x: 430, y: 315, connections: ["center_hub"] },
      { id: "sat_11", label: "Node 11", type: "DOCUMENT", category: "Doc", urn: "urn:axios:doc:n11", x: 440, y: 270, connections: ["center_hub"] },

      { id: "sat_12", label: "Bottom Anchor", type: "EQUIPMENT", category: "Asset", urn: "urn:axios:asset:ba", x: 475, y: 415, connections: ["focal_bottom_right"] },
      { id: "sat_13", label: "Sub Valve", type: "SENSOR", category: "Valve", urn: "urn:axios:asset:sv", x: 495, y: 340, connections: ["center_hub"] },
      { id: "sat_14", label: "Trace ID", type: "DOCUMENT", category: "Doc", urn: "urn:axios:doc:tr", x: 435, y: 350, connections: ["center_hub"] },
    ];
